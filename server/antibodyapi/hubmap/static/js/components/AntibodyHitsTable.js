...
class AntibodyHitsTable extends React.Component {
  ...
  render(){
    ...
    for (var i = 0; i < hits.length; i++) {
      ...
      antibodies += '<td class="tissue_preservation_col" style="display:'+display.tissue_preservation+`;">${hit._source.tissue_preservation}</td>`;
        ...
        <table id="antibody-results-table" className="sk-table sk-table-striped" style={{width: '100%', boxSizing: 'border-box'}}>
          <thead>
            <tr>
              ...
              <th id="tissue_preservation_col_head" style={{"display": display.tissue_preservation}}>Tissue Preservation</th>
